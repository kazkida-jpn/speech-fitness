...
const styles = StyleSheet.create({
  ...
  topButtonText: { color: palette.greenDark, fontSize: 15, fontWeight: '800' },
  hero: { marginTop: 40 },
  heroTag: { color: palette.green, fontSize: 16, fontWeight: '800' },
  heroTitle: {
    color: palette.ink,
    fontSize: 40,
    lineHeight: 52,
  ...
  heroLead: { color: palette.muted, fontSize: 17, lineHeight: 29, marginTop: 16, maxWidth: 620 },
  heroActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 22 },
  heroNote: { color: palette.muted, fontSize: 15, marginTop: 12 },
  primaryButton: {
  ...
  demoLabel: { color: '#CBE9DD', fontSize: 14, fontWeight: '800' },
  ...
  demoMetricLabel: { color: '#CBE9DD', fontSize: 14, fontWeight: '700' },
  demoMetricValue: { color: palette.white, fontSize: 24, fontWeight: '800', marginTop: 4 },
  demoMetricSub: { color: '#E6F4EF', fontSize: 15, marginTop: 2 },
  demoBars: {
    flexDirection: 'row',
    alignItems: 'flex-end',
    gap: 8,
  ...
  demoDiagnosis: { color: '#E6F4EF', fontSize: 16, lineHeight: 26, marginTop: 16 },
  sectionTitle: {
    color: palette.ink,
    fontSize: 24,
    fontWeight: '800',
  ...
  valueTitle: { color: palette.greenDark, fontSize: 20, fontWeight: '800' },
  valueBody: { color: palette.muted, fontSize: 16, lineHeight: 26, marginTop: 8 },
  stepList: { gap: 12 },
  ...
  stepBadgeText: { color: palette.greenDark, fontSize: 16, fontWeight: '800' },
  stepText: { flex: 1 },
  stepTitle: { color: palette.ink, fontSize: 17, fontWeight: '800' },
  stepBody: { color: palette.muted, fontSize: 16, lineHeight: 25, marginTop: 3 },
  ...
  drillTitle: { color: palette.ink, fontSize: 16, fontWeight: '800' },
  drillBody: { color: palette.muted, fontSize: 14, lineHeight: 22, marginTop: 5 },
  drillFree: {
  ...
  planName: { color: palette.muted, fontSize: 15, fontWeight: '800' },
  planPrice: { color: palette.ink, fontSize: 32, fontWeight: '800', marginTop: 4 },
  planPer: { color: palette.muted, fontSize: 16, fontWeight: '700' },
  planAlt: { color: palette.muted, fontSize: 15, marginTop: 2, marginBottom: 10 },
  planItem: { color: palette.ink, fontSize: 16, lineHeight: 27 },
  planTrial: { color: palette.green, fontSize: 15, fontWeight: '700', marginTop: 10 },
  safetyCard: {
    marginTop: 34,
  ...
  safetyTitle: { color: palette.amber, fontSize: 16, fontWeight: '800' },
  safetyBody: { color: palette.ink, fontSize: 16, lineHeight: 26 },
  faqList: { gap: 10 },
  faqItem: {
    backgroundColor: palette.white,
    borderRadius: 16,
  ...
  faqQuestion: { color: palette.ink, fontSize: 16, fontWeight: '800' },
  faqAnswer: { color: palette.muted, fontSize: 16, lineHeight: 26, marginTop: 6 },
  closing: { alignItems: 'center', gap: 14, marginTop: 44 },
  closingTitle: { color: palette.ink, fontSize: 24, fontWeight: '800', textAlign: 'center' },
});

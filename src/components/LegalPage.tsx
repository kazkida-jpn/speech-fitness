...
export const legalStyles = StyleSheet.create({
  ...
  rowLabel: { width: 160, color: palette.ink, fontSize: 16, fontWeight: '800', lineHeight: 27 },
  rowValue: { flex: 1, minWidth: 220, color: palette.ink, fontSize: 16, lineHeight: 27 },
});
...
const styles = StyleSheet.create({
  ...
  updated: { color: palette.muted, fontSize: 15, marginTop: 6 },
  lead: { color: palette.ink, fontSize: 16, lineHeight: 27, marginTop: 16 },
  section: { marginTop: 26 },
  heading: { color: palette.ink, fontSize: 18, fontWeight: '800', marginBottom: 8 },
  paragraph: { color: palette.ink, fontSize: 16, lineHeight: 27, marginBottom: 8 },
  list: { marginBottom: 8, gap: 4 },
  listItem: { flexDirection: 'row' },
  bullet: { color: palette.muted, fontSize: 16, lineHeight: 27, width: 18 },
  listText: { flex: 1, color: palette.ink, fontSize: 16, lineHeight: 27 },
});

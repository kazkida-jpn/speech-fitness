...
const styles = StyleSheet.create({
  ...
  inputName: { color: palette.ink, fontSize: 16, fontWeight: '800', marginTop: 2 },
  inputMeta: { color: palette.muted, fontSize: 12, marginTop: 2 },
  inputAction: {
  ...
  inputActionText: { color: palette.greenDark, fontSize: 15, fontWeight: '800' },
  inputList: {
    backgroundColor: palette.white,
    borderWidth: 1,
    borderColor: palette.line,
  ...
  inputOptionName: { color: palette.ink, fontSize: 16, fontWeight: '700' },
  inputOptionType: { color: palette.muted, fontSize: 12, marginTop: 2 },
  inputConfirmButton: {
  ...
  inputConfirmButtonText: { color: palette.white, fontSize: 16, fontWeight: '800' },
  errorText: {

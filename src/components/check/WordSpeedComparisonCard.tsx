...
const styles = StyleSheet.create({
  ...
  wordComparisonEyebrow: { color: palette.greenDark, fontSize: 14, fontWeight: '800' },
  wordComparisonTitle: { color: palette.ink, fontSize: 22, fontWeight: '800', marginTop: 3 },
  wordComparisonNote: { color: palette.muted, fontSize: 14, lineHeight: 23, marginTop: 5 },
  ...
  wordComparisonWord: { color: palette.ink, fontSize: 17, fontWeight: '800', minWidth: 80 },
  wordComparisonGuidance: { flex: 1, minWidth: 180 },
  wordComparisonTip: { color: palette.muted, fontSize: 12, lineHeight: 19, marginTop: 3 },
  ...
  wordScoreLabel: { color: palette.muted, fontSize: 12, fontWeight: '700' },
  wordScoreValue: { fontSize: 18, fontWeight: '800' },
  wordComparisonArrow: { color: palette.muted, fontSize: 15 },
  wordDrop: { color: '#B15B23', fontSize: 16, fontWeight: '800', minWidth: 30 },
  wordComparisonFootnote: { color: palette.muted, fontSize: 12, lineHeight: 20, marginTop: 14 },
});

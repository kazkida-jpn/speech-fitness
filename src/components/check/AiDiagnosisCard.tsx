...
const styles = StyleSheet.create({
  ...
  aiDiagnosisEyebrow: { color: palette.amber, fontSize: 14, fontWeight: '800' },
  aiDiagnosisTitle: { color: palette.ink, fontSize: 22, fontWeight: '800', marginTop: 2 },
  aiBadge: {
    color: palette.amber,
    fontSize: 12,
    fontWeight: '800',
  ...
  aiDiagnosisLoading: { color: palette.muted, fontSize: 16, lineHeight: 26, marginTop: 16 },
  aiDiagnosisHeadline: {
    color: palette.ink,
    fontSize: 21,
    lineHeight: 30,
  ...
  aiDiagnosisSummary: { color: palette.ink, fontSize: 16, lineHeight: 27, marginTop: 8 },
  ...
  aiDiagnosisItem: { color: palette.ink, fontSize: 15, lineHeight: 25 },
  practiceBox: { backgroundColor: palette.white, borderRadius: 13, padding: 13, marginTop: 15 },
  practiceLabel: { color: palette.greenDark, fontSize: 14, fontWeight: '800' },
  practiceText: { color: palette.ink, fontSize: 15, lineHeight: 25, marginTop: 4 },
  ...
  recommendedDrillEyebrow: { color: palette.greenDark, fontSize: 14, fontWeight: '800' },
  premiumBadge: {
    color: palette.amber,
    fontSize: 12,
    fontWeight: '800',
  ...
  recommendedDrillTitle: { color: palette.ink, fontSize: 19, fontWeight: '800', marginTop: 8 },
  recommendedDrillReason: { color: palette.muted, fontSize: 15, lineHeight: 24, marginTop: 5 },
  ...
  recommendedDrillButtonText: { color: palette.white, fontSize: 16, fontWeight: '800' },
  paywallCard: {
  ...
  paywallTitle: { color: palette.ink, fontSize: 17, fontWeight: '800' },
  paywallText: { color: palette.muted, fontSize: 14, lineHeight: 23, marginTop: 6 },
  paywallClose: {
    color: palette.muted,
    fontSize: 14,
    fontWeight: '700',
  ...
  aiDiagnosisError: { color: palette.danger, fontSize: 15, lineHeight: 24, marginTop: 15 },
  aiRetryButton: {
    borderWidth: 1,
    borderColor: '#C7A747',
    borderRadius: 12,
  ...
  aiRetryButtonText: { color: palette.amber, fontSize: 15, fontWeight: '800' },
  aiDiagnosisNote: { color: palette.muted, fontSize: 12, lineHeight: 19, marginTop: 14 },
});

...
const styles = StyleSheet.create({
  ...
  clarityLabel: { color: palette.greenDark, fontSize: 15, fontWeight: '800' },
  clarityScore: { color: palette.ink, fontSize: 32, fontWeight: '800', marginTop: 3 },
  ...
  assessmentWarningTitle: { color: palette.amber, fontSize: 15, fontWeight: '800' },
  assessmentWarningText: { color: palette.amber, fontSize: 14, lineHeight: 22, marginTop: 3 },
  recognizedLabel: { color: palette.muted, fontSize: 14, fontWeight: '700', marginTop: 13 },
  recognizedText: {
    color: palette.ink,
    fontSize: 16,
    lineHeight: 26,
  ...
  unclearTitle: { color: palette.ink, fontSize: 16, fontWeight: '800', marginTop: 13 },
  ...
  wordChipText: { color: '#9A3A2A', fontSize: 15, fontWeight: '700' },
  omissionNote: { color: palette.amber, fontSize: 14, lineHeight: 22, marginTop: 9 },
  clarityNote: { color: palette.muted, fontSize: 12, lineHeight: 19, marginTop: 10 },
});

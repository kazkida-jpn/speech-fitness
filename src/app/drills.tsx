...
const styles = StyleSheet.create({
  ...
  hero: { color: palette.ink, fontSize: 29, lineHeight: 38, fontWeight: '800' },
  intro: { color: palette.muted, fontSize: 16, lineHeight: 25, marginTop: 7, marginBottom: 20 },
  ...
  drillTitle: { color: palette.ink, fontSize: 19, fontWeight: '800' },
  premiumBadge: {
    color: palette.amber,
  ...
  drillBody: { color: palette.muted, fontSize: 15, lineHeight: 23, marginTop: 7 },
  startLink: {
    color: palette.greenDark,
    fontSize: 15,
    fontWeight: '800',
  ...
  change: { color: palette.green, fontSize: 15, fontWeight: '700', marginBottom: 13 },
  diagnosisBanner: {
  ...
  diagnosisBannerTitle: { color: palette.amber, fontSize: 15, fontWeight: '800' },
  diagnosisBannerText: { color: palette.muted, fontSize: 14, lineHeight: 22, marginTop: 3 },
  practiceMeterCard: {
    backgroundColor: palette.white,
    borderRadius: 20,
    padding: 16,
  ...
  practiceMeterValue: { color: palette.greenDark, fontSize: 26, fontWeight: '800' },
  practiceMeterUnit: { color: palette.greenDark, fontSize: 12, fontWeight: '800' },
  practiceMeterCopy: { flex: 1 },
  practiceMeterTitle: { color: palette.ink, fontSize: 17, fontWeight: '800' },
  practiceMeterText: { color: palette.muted, fontSize: 14, lineHeight: 23, marginTop: 4 },
  practiceCard: {
    backgroundColor: palette.white,
    borderRadius: 24,
    padding: 22,
  ...
  progress: { color: palette.green, fontSize: 14, fontWeight: '800' },
  sentence: {
    color: palette.ink,
    fontSize: 25,
    lineHeight: 41,
  ...
  micDot: { color: palette.white, fontSize: 20 },
  timer: { color: palette.ink, fontSize: 27, fontWeight: '800', marginTop: 8 },
  status: { color: palette.muted, fontSize: 15, marginTop: 4, textAlign: 'center' },
  primary: {
    backgroundColor: palette.green,
    borderRadius: 15,
    alignItems: 'center',
  ...
  stopText: { color: palette.danger, fontSize: 16, fontWeight: '800' },
  actions: { gap: 10 },
  secondary: {
    borderWidth: 1,
  ...
  secondaryText: { color: palette.greenDark, fontSize: 16, fontWeight: '800' },
  reflectionCard: { backgroundColor: palette.cream, borderRadius: 15, padding: 13 },
  reflectionTitle: { color: palette.ink, fontSize: 16, fontWeight: '800' },
  reflectionHint: { color: palette.muted, fontSize: 12, lineHeight: 19, marginTop: 4 },
  ...
  reflectionChipText: { color: palette.greenDark, fontSize: 14, fontWeight: '700' },
  ...
  error: { color: palette.danger, fontSize: 15, textAlign: 'center', marginTop: 10 },
  completeCard: {
    backgroundColor: palette.white,
    borderRadius: 24,
    padding: 28,
  ...
  completeTitle: { color: palette.ink, fontSize: 25, fontWeight: '800', marginTop: 6 },
  completeValue: { color: palette.greenDark, fontSize: 20, fontWeight: '800', marginTop: 10 },
  completeNote: { color: palette.muted, fontSize: 15, marginTop: 5, marginBottom: 20 },
});

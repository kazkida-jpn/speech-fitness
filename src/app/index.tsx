...
const styles = StyleSheet.create({
  ...
  logo: { color: colors.ink, fontSize: 24, fontWeight: '800', marginTop: 3 },
  userName: { color: colors.muted, fontSize: 12, maxWidth: 220 },
  loginButton: {
  ...
  loginButtonText: { color: colors.greenDark, fontSize: 12, fontWeight: '800' },

...
const styles = StyleSheet.create({
  ...
  dayLabel: { color: palette.muted, fontSize: 12 },
  dayValue: { color: palette.greenDark, fontSize: 17, fontWeight: '800' },
  heroCard: {
    backgroundColor: palette.white,
    borderRadius: 28,
    padding: 22,
  ...
  step: { color: palette.green, fontWeight: '800', fontSize: 16 },
  stepCount: { color: palette.muted, fontSize: 16 },
  heroTitle: { color: palette.ink, fontSize: 30, lineHeight: 39, fontWeight: '800' },
  instruction: { color: palette.muted, fontSize: 17, lineHeight: 26, marginTop: 8 },
  textCard: { backgroundColor: palette.mint, borderRadius: 20, padding: 20, marginTop: 20 },
  testText: { color: palette.ink, fontSize: 23, lineHeight: 39, fontWeight: '600' },
  ...
  micSymbol: { color: palette.white, fontSize: 20 },
  timer: { color: palette.ink, fontSize: 34, fontWeight: '700', marginTop: 12 },
  status: { color: palette.muted, fontSize: 16, marginTop: 4 },
  primaryButton: {
    backgroundColor: palette.green,
    paddingVertical: 17,
    borderRadius: 18,
  ...
  secondaryButtonText: { color: palette.greenDark, fontSize: 19, fontWeight: '800' },
  stopButton: {
  ...
  stopButtonText: { color: palette.danger, fontSize: 19, fontWeight: '800' },
  errorText: {
  ...
  completeBadgeText: { color: palette.greenDark, fontSize: 15, fontWeight: '800' },
  privacyNote: {
    color: palette.muted,
    fontSize: 15,
    lineHeight: 24,
